...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        guacRecipe.setUrl("www.boring-recipes.com/guacamole");
        guacRecipe.setServings(4);
        guacRecipe.setSource("Boring Recipes");
        ...
        tacosRecipe.setUrl("www.boring-recipes.com/tacos");
        tacosRecipe.setServings(6);
        tacosRecipe.setSource("Boring Recipes");
